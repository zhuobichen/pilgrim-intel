$taskName = "AbstractCultureDaily"
$description = "Abstract Culture Daily Tracker - 11 sources + DeepSeek + email"
...
$action = New-ScheduledTaskAction -Execute "E:\CodeProject\abstract_culture_tracker\scripts\daily-run.bat"
