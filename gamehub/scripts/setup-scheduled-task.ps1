$taskName = "GameHubDailyDigest"
$description = "GameHub game news daily digest - 11 sources + DeepSeek + email"
...
$action = New-ScheduledTaskAction -Execute "E:\CodeProject\GameHub\scripts\daily-run.bat"
