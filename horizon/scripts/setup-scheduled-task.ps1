$taskName = "HorizonDailyReport"
$description = "Horizon AI news daily digest - DeepSeek + email"
...
$action = New-ScheduledTaskAction -Execute "E:\CodeProject\Horizon\scripts\daily-run.bat"
